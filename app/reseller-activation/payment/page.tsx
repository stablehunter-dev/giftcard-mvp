...
function PaymentContent() {
    ...
    const generatePayment = async () => {
        ...
        // Simulate fetching real-time gold price and calculating new payment amount
        try {
            ...
            setCurrentPrice(price); // Use original price as fallback
        }

        // Generate mock ERC-20 payment address (0x format)
    ...
    // Countdown timer with expiration and warning
    useEffect(() => {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-xl mx-auto px-4 h-14 flex items-center justify-between">
                    ...
                    <h1 className="font-bold text-lg text-gray-900">完成支付</h1>
                    <div className="w-10"></div>
                </div>
            </header>

            <main className="max-w-xl mx-auto px-4 py-6 space-y-6 pb-32">
                {/* Combined Card Info & Payment Amount */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                        {/* Left: Card Details */}
                        ...
                        <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-4 border border-amber-100 text-center sm:text-right">
                            <h2 className="text-xs font-semibold text-gray-500 mb-1">需支付金額</h2>
                            <div className="flex items-baseline justify-center sm:justify-end gap-1.5">
                                <span className="text-3xl sm:text-4xl font-bold text-gray-900">{currentPrice}</span>
                                <span className="text-lg font-medium text-gray-600">USDT</span>
                            </div>
                ...
                {paymentStatus === 'pending' && (
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-base font-semibold text-gray-900">支付方式</h2>
                            <div className={`flex items-center gap-2 text-sm ${showWarning ? 'text-red-500 animate-pulse' :
                        ...
                        {showWarning && !isExpired && (
                            <div className="mb-4 bg-red-50 border border-red-200 rounded-lg p-3">
                                <div className="flex items-center gap-2 text-red-700">
                                    ...
                                    <span className="text-sm font-medium">支付即將過期，請盡快完成支付！</span>
                                </div>
                            </div>
                        )}
                        ...
                        {isExpired ? (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">支付已過期</h3>
                                <p className="text-sm text-gray-600 mb-6">請點擊下方按鈕獲取新的支付信息</p>
                                <button
                                    onClick={generatePayment}
                                    className="px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white font-medium rounded-full hover:shadow-lg transition-all"
                                >
                                    重新獲取支付信息
                                </button>
                            </div>
                            ...
                            <>
                                {/* QR Code Placeholder */}
                                <div className="bg-gray-50 rounded-xl p-8 mb-4 flex flex-col items-center justify-center border-2 border-dashed border-gray-200">
                                    <div className="w-48 h-48 bg-white rounded-lg shadow-sm flex items-center justify-center mb-4">
                                        <div className="text-center">
                                            ...
                                            <p className="text-sm text-gray-400">支付二維碼</p>
                                        </div>
                                    </div>
                                    <p className="text-sm text-gray-500 text-center">掃描二維碼或複製地址進行支付</p>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            readOnly
                                            className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs text-gray-900"
                                        />
                                        <button
                                            onClick={() => {
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div className="text-sm text-blue-800">
                                            ...
                                            <ul className="space-y-1 text-blue-700">
                                                <li>• 請確保支付金額準確為 {currentPrice} USDT</li>
                                                <li>• <strong>僅支持 ERC-20 網絡</strong></li>
                                                <li>• 支付有效期1分鐘，過期需重新獲取</li>
                                                <li>• 支付完成後系統將自動檢測</li>
                                            </ul>
                                        </div>
                                    </div>
